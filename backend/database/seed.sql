-- =============================================
-- Seed Data for Vacation Management System
-- Populates the database with initial users and vacation requests.
-- =============================================

-- Insert default users (Manager & Employees)
...
-- This data helps test the vacation request functionality.
...
-- =============================================
-- Audit Logs (Not in Use)
-- =============================================
-- This section was originally intended to track system actions (e.g., user creation, approvals).
-- However, this functionality is currently under development and is not in use.
